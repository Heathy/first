<?php
    ...
    $preVal = isset($_GET['preVal']) ? $_GET['preVal'] : '';
    $nextVal = isset($_GET['nextVal']) ? $_GET['nextVal'] : '';
    ...
    */
    ...
    //sql语句
    $index = ($page - 1) * $num;
    $sql = "SELECT * FROM kaola 
     WHERE name LIKE '%$searchVal%'
      AND price BETWEEN $preVal AND $nextVal 
      ORDER BY price $paixu 
       LIMIT $page,$num";
    ...
    //查询总条数
    $sql2 = "SELECT * FROM sheet1 WHERE price BETWEEN $preVal AND $nextVal";
