...
(function () {
    ...
    var p = new Promise(function (resolve) {
        $.ajax({
            type: 'get',
            url: '../api/goodlist.php',//替换成你的接口即可
            success: str => {
                // console.log(str);
                resolve(str);
            }
            ...
            return `<div class="goods-item" data-id="${item.id}">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="col-md-3 car-goods-info goods-image-column"><img class="goods-image" src="${item.url}"
                                        style="width: 100px; height: 100px;"><span
                                        id="goods-info">${item.name}</span></div>
                                <div class="col-md-3 car-goods-info goods-params">${item.dename}</div>
                                <div class="col-md-1 car-goods-info goods-price"><span>￥</span><span
                                        class="single-price" >${item.newprice}</span></div>
    ...
    function changeNum(arr) {
        ...
        $('#electGoodsCount').html(total);
        $('#selectGoodsMoney').html(price);
    }
})();